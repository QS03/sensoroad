...
map.on('load', function() {
  pointArray = [
    ...
    properties: {RATE: 3, LON: -122.4833858013153, LAT: 37.829607404976734, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.4830961227417, 37.82932776098012], type: "Point"}, 
    properties: {RATE: 4, LON: -122.4830961227417, LAT: 37.82932776098012, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48339653015138, 37.83270036637107], type: "Point"}, 
    properties: {RATE: 1, LON: -122.48339653015138, LAT: 37.83270036637107, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48356819152832, 37.832056363179625], type: "Point"}, 
    properties: {RATE: 6, LON: -122.48356819152832, LAT: 37.832056363179625, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48404026031496, 37.83114119107971], type: "Point"}, 
    properties: {RATE: 7, LON: -122.48404026031496, LAT: 37.83114119107971, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48404026031496, 37.83049717427869], type: "Point"}, 
    properties: {RATE: 8, LON: -122.48404026031496, LAT: 37.83049717427869, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48348236083984, 37.829920943955045], type: "Point"}, 
    properties: {RATE: 9, LON: -122.48348236083984, LAT: 37.829920943955045, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48356819152832, 37.82954808664175], type: "Point"}, 
    properties: {RATE: 2, LON: -122.48356819152832, LAT: 37.82954808664175, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48507022857666, 37.82944639795659], type: "Point"}, 
    properties: {RATE: 10, LON: -122.48507022857666, LAT: 37.82944639795659, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48610019683838, 37.82880236636284], type: "Point"}, 
    properties: {RATE: 5, LON: -122.48610019683838, LAT: 37.82880236636284, IMAGE_URL: 'assets/img/test.jpg'}},
    {type: "Feature", geometry: { coordinates: [-122.48695850372314, 37.82931081282506], type: "Point"}, 
    properties: {RATE: 5, LON: -122.48695850372314, LAT: 37.82931081282506, IMAGE_URL: 'assets/img/test.jpg'}},
